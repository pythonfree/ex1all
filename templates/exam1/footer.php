                ...
                <div class="side">
					...
					<?$APPLICATION->IncludeComponent(
						...
						array(
							...
							"ROOT_MENU_TYPE" => ($APPLICATION->GetCurPage(false) !== '/products/') ? 'top' : 'left',
							"MENU_CACHE_TYPE" => "N",
					...
					<!-- side anonse -->
					<?
					$curSectInc = $_SERVER['DOCUMENT_ROOT'] . $APPLICATION->GetCurPage(false) . 'sect_inc.php';
					if(is_readable($curSectInc)):?>
		                     ...
		                     <div class="rew-footer-carousel">
								<?$APPLICATION->IncludeComponent(
								   ...
								   Array(
									   ...
									   "CHECK_DATES" => "N",
									   "DETAIL_URL" => "#SITE_DIR#/rews/#ELEMENT_CODE#/",
									   "AJAX_MODE" => "N",
									   "AJAX_OPTION_JUMP" => "N",
									   "AJAX_OPTION_STYLE" => "Y",
